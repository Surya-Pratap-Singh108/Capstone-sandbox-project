...
export const listFiles=tool(
    async ({})=>{
        ...
        console.log("===============================");
        const response=await axios.get('http://019f608c-0136-70ce-acbe-310cb5fbd9ac.agent.localhost/list-files');
...
export const readFiles=tool(
    async ({files=[]})=>{
        ...
        console.log("===============================");
        const response=await axios.get('http://019f608c-0136-70ce-acbe-310cb5fbd9ac.agent.localhost/read-files?files='+files.join(','));
...
export const updateFiles=tool(
    async ({files})=>{
        ...
        console.log("===============================");
        const response=await axios.patch('http://019f608c-0136-70ce-acbe-310cb5fbd9ac.agent.localhost/update-files',{
            updates:files
        });
        console.log("===============================");
